...
2.  Erstelle mit rnorm eine Normalverteilung in R
3.  Insgesamt soll diese Verteilung Hunderttausend Werte haben
4.  Mittelwert dieser Menge sind 175 Zentimeter
5.  Die Werte streuen mit einer Standardabweichung von 10 Zentimetern
:::
...
1.  `geom_density` zeigt die Dichte einer Verteilung. So sind bei 175 mehr Werte, als bei 225
:::
