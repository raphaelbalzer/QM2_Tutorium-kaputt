# Wahrscheinlichkeiten (Kap. 2 -- 4 in Bourier (2018))
...
$$W(S\cap \neg M) = \frac{5}{100} = 0,05$$
Diese Wahrscheinlichkeit nennt sich **gemeinsame Wahrscheinlichkeit.**
:::
...
Anteil derer die Mathe bestanden haben, von allen, die Statistik nicht bestanden haben
...
Was können wir auf Grundlage dieser Aussage über die Beziehung zwischen A und B schließen?
...
$$W(leichter\ Krankheitsverlauf|Blutgruppe\ A) = W(leichter\ Krankheitsverlauf|Blutgruppe\ B)$$
Heißt: Die Wahrscheinlichkeit einen leichten Krankheitsverlauf zu haben, wenn man zur Blutgruppe A gehört, ist genauso hoch, wie die Wahrscheinlichkeit einen leichten Krankheitsverlauf zu haben, wenn man zu Blutgruppe B gehört. Das heißt, es ist egal, ob ein Patient Blutgruppe A oder B hat, die Wahrscheinlichkeit, einen leichten Krankheitsverlauf zu haben, bleibt die gleiche und wird somit nicht von der Blutgruppe bestimmt.
:::
...
#### L12 b)
$$W(B|\neg A) = \frac{12}{36} = 0.33$$
$$W(B|A) = \frac{36}{48} = 0.75$$
:::
